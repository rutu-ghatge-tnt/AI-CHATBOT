...
from app.hl_engine.models.profile import UserProfile
...
def personalize_alert(
    ...
    personalized_headline = build_personalized_headline(profile.primary_concern, profile.skin_type, env)
    personalized_whats_happening = f"{personalized_headline} {generic_alert.whats_happening}"
    personalized_key_dont = get_concern_key_dont(profile.primary_concern, env) or generic_alert.key_dont
    ...
    return PersonalizedAlertResponse(
        ...
        science_fact=generic_alert.science_fact,
        science_source=generic_alert.science_source,
        scenario_code=generic_alert.scenario_code,
        scenario_number=generic_alert.scenario_number,
