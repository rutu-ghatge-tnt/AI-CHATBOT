...
# Align with scan_log + daily_log_store.RETENTION_DAYS (history window).
_DAILY_LOG_TTL_SEC = 60 * 24 * 3600
# Behavioral logs without product permanence — same window as action/feeling.
_AUX_LOG_TTL_SEC = 90 * 24 * 3600
...
async def ensure_hlhp_indexes() -> None:
    ...
    try:
        ...
        # TTL on updated_at: dormant rows expire; active days keep refreshing.
        await _safe_create_index(
            daily_log, "updated_at", expireAfterSeconds=_DAILY_LOG_TTL_SEC
        )
